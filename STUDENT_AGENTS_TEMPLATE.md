# AGENTS.md template for student projects

Copy this into `AGENTS.md` in the project root, then adjust names/commands for the specific project.
...
- If this repo uses npm, keep `vercel.json` with:
